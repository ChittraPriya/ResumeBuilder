  ...
  return (
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>
                {data.image ? (
                    <img src={typeof data.image === 'string' ? data.image : URL.createObjectURL(data.image)} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opactity-80' />
                ) : (
                    <div className='inline-flex items-center gap-2 mt-5 texty-slate-600 hover:text-slate-700 cursor-pointer'>
            ...
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm'>
                    ...
                    <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <div className='w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-pink-600 trandition-solors duration-200'>
                        </div>
