            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        ...
                        <a href="#cta" className="hover:text-pink-600 transition">Contact</a>
                    </div>

                    <div className="flex gap-2">
                        <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-pink-500 hover:bg-pink-700 active:scale-95 transition-all rounded-full text-white " hidden={user}>
                            Get started
                        </Link>
                        ...
                        <Link to='/app' className='hidden md:block px-8 py-2 bg-pink-500 hover:bg-pink-700 active:scale-95 transition-all rounded-full text-white' hidden={!user}>
                        Dashboard
                        </Link>
                    </div>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <a href="/stories" className="text-white">Testimonials</a>
                    <a href="/pricing" className="text-white">Contact</a>
                    <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-pink-600 hover:bg-pink-700 transition text-white rounded-md flex" >
                        X
                    </button>
                </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Craft the Perfect Resume with Your <span className=" bg-gradient-to-r from-pink-700 to-pink-600 bg-clip-text text-transparent text-nowrap">AI Career </span> Partner.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Design, edit and download professional, job-winning resumes effortlessly - let AI help you stand out and land tour dream job.</p>

                    {/* CTA Buttons */}
                    <div className="flex items-center gap-4 ">
                        <Link to='/app' className="bg-pink-500 hover:bg-pink-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-pink-400 flex items-center transition-colors">
                            Get started
